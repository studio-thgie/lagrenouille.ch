...
<ul aria-label="Sprachwahl" class="g-lang-change">
    <?php foreach(icl_get_languages() as $lang): ?>
        <li class="g-lang-change__item <?php if($lang['active']){ echo 'g-lang-change__item--active'; } ?>" data-effect="random-rotate"><a href="<?php echo $lang['url']; ?><?php if(strlen($_SERVER['QUERY_STRING'])>0){ echo '?'.$_SERVER['QUERY_STRING']; } ?>"><?php echo $lang['language_code']; ?></a></li>
    <?php endforeach; ?>
</ul>
